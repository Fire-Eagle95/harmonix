...
def write():
    ...
    print '!</font></h1><br/><br/><br/><form name="input" action="http://cgi.cs.mcgill.ca/~cschor/cgi-bin/MyFacebookPage.py" method="POST"><p><font color=#CC0099>Hey ! Update your status and tell us what is on your musical mind:</font></p><br/><input type="hidden" name="username" value='
    ...
    if fList:
        ...
        if topicsToPrint:
            ...
            for toWrite in topicsToPrint:
                ...
                print '</center></td></tr>'
            print '</table>'
    print '<form name="input" action="http://cgi.cs.mcgill.ca/~cschor/cgi-bin/MyFacebookPage.py" method="POST"><p><font color=#CC0099>Add a SiDoReLa member to your FriendList: </font> </p><br><input type="hidden" name="username" value='
    print currentUser.us
    print '><input type="text" name="friend" size=15><br><input type="submit" value="Submit"></form></center></td><td width=150 bgcolor=#993366><font color=#00FFFF><i>SiDoReLa members:</i><ul>'
    sidorelas = membersList()
    for member in sidorelas:
        print '<li>'
        print member
        print '</li>'
    print '</ul><a href="http://cgi.cs.mcgill.ca/~pgianf/harmonix/Pierre/become_member.html">LOGOUT</a></font></td></tr></table></body></html>'
    return
